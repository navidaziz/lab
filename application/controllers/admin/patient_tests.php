...
class Patient_tests extends Admin_Controller{
    ...
    $this->data["tests"] = $this->patient_test_model->getList("tests", "test_id", "test_name", $where ="`tests`.`status` IN (1) ");
        ...
        $this->data["title"] = $this->lang->line('Add New Patient Test');$this->data["view"] = ADMIN_DIR."patient_tests/add_patient_test";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
    ...
    $this->data["tests"] = $this->patient_test_model->getList("tests", "test_id", "test_name", $where ="`tests`.`status` IN (1) ");
        ...
        $this->data["title"] = $this->lang->line('Edit Patient Test');$this->data["view"] = ADMIN_DIR."patient_tests/edit_patient_test";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
