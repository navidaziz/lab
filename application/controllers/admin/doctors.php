...
class Doctors extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Doctor');$this->data["view"] = ADMIN_DIR."doctors/add_doctor";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($doctor_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Doctor');$this->data["view"] = ADMIN_DIR."doctors/edit_doctor";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
