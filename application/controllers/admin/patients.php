...
class Patients extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Patient');$this->data["view"] = ADMIN_DIR."patients/add_patient";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($patient_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Patient');$this->data["view"] = ADMIN_DIR."patients/edit_patient";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
