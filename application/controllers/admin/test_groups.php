...
class Test_groups extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Test Group');$this->data["view"] = ADMIN_DIR."test_groups/add_test_group";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($test_group_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Test Group');$this->data["view"] = ADMIN_DIR."test_groups/edit_test_group";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
