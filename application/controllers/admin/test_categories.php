...
class Test_categories extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Test Category');$this->data["view"] = ADMIN_DIR."test_categories/add_test_category";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($test_category_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Test Category');$this->data["view"] = ADMIN_DIR."test_categories/edit_test_category";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
