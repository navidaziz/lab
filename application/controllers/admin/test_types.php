...
class Test_types extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Test Type');$this->data["view"] = ADMIN_DIR."test_types/add_test_type";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($test_type_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Test Type');$this->data["view"] = ADMIN_DIR."test_types/edit_test_type";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
