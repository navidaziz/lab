...
class Home_page extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Home Page');$this->data["view"] = ADMIN_DIR."home_page/add_home_page";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($home_page_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Home Page');$this->data["view"] = ADMIN_DIR."home_page/edit_home_page";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
