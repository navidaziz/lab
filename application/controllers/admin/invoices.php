...
class Invoices extends Admin_Controller{
    ...
    $this->data["doctors"] = $this->invoice_model->getList("doctors", "doctor_id", "doctor_name", $where ="`doctors`.`status` IN (1) ");
        ...
        $this->data["title"] = $this->lang->line('Add New Invoice');$this->data["view"] = ADMIN_DIR."invoices/add_invoice";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
    ...
    $this->data["doctors"] = $this->invoice_model->getList("doctors", "doctor_id", "doctor_name", $where ="`doctors`.`status` IN (1) ");
        ...
        $this->data["title"] = $this->lang->line('Edit Invoice');$this->data["view"] = ADMIN_DIR."invoices/edit_invoice";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
