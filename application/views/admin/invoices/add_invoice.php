	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."invoices/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("patient_id", $patients, "", "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("patient_refer_by", $doctors, "", "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
